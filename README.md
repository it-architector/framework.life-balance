...
Это мне не понравилось, и я решил со всех реализованных framework сбросить лишнее (всю уёбищность и вредительство), дабы из ценного и нужного собрать платформу (временную) Life Balance, а там посмотрим куда дальше.
...
Для минимизации ручного труда была введена автоматизация: фиксация сбоя, фоновый запуск, работа с базой данных с автосозданием таблиц, чпу.
