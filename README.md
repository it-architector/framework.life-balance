...
Это мне не понравилось, и я решил со всех реализованных framework сбросить лишнее (всю уёбищность и вредительство), дабы по остаткам выявить правильность и упорядочить код до платформы Life Balance, а там посмотрим куда дальше.
...
Структура платформы должна изолировать ядро (back-end) от интерфейса (front-end). Взаимодействие между ними утвердить в виде "запрос-ответ".
