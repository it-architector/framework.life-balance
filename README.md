...
| № | Ядро | Интефрейс
 ------------- | ------------- | ------------- | 
| 1.| <a target="_blank" href="/Компоненты ядра/1.Решения/Сведения/Версия ядра.md">Версия ядра</a> | <a target="_blank" href="/Компоненты интерфейса/1.Интеллект/Сведения/Версия интерфейса.md">Версия интерфейса</a> 
| 2.| <a target="_blank" href="/Компоненты ядра/1.Решения/Сведения/Основные функции.md">Основные функции</a> |  
| 3.| <a target="_blank" href="/Компоненты ядра/1.Решения/Сведения/Сведения для разработки.md">Сведения для разработки</a> |  
| 4.| <a target="_blank" href="/Компоненты ядра/1.Решения/Сведения/Стандарт схемы базы данных.md">Стандарт схемы базы данных</a> |  
| 5.| <a target="_blank" href="/Компоненты ядра/1.Решения/Сведения/Стандарт схемы взаимодействия с базой данных.md">Стандарт схемы взаимодействия с базой данных</a> |  
| 6.| <a target="_blank" href="/Компоненты ядра/1.Решения/Сведения/Стандарт схемы наработок.md">Стандарт схемы наработок</a> |  
