...
Порядок разработки и структура фреймворка выстроена так, что позволяет компаниям равномерно перейти на форму управления "холакратия" для непрерывной разработки web-сайтов, при этом раскрывать особенности разработчиков, вводить всё больше автономности, высвобождать человеческие ресурсы и оперативно устранять в команде участки большого напряжения.
