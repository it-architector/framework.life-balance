...
p.s.2. Данный framework так же не сопровождает программирование, но дал шанс родиться <a target="_blank" href="https://github.com/it-architector/project.csdr">проекту csdr</a>.
