...
Порядок разработки и структура фреймворка выстроена так, что позволяет компаниям равномерно перейти на форму управления "холакратия" для беспрепятственного разрабатывания web-сайтов, при этом раскрывать особенности разработчиков, вводить всё больше автономности, высвобождать человеческие ресурсы и оперативно устранять участки большого напряжения в команде.
