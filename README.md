...
Framework life balance предназначен для **сопровождения** всех этапов разработки сайта (<a target="_blank" href="/Компоненты ядра/1.Условия/3.Требования/5.Требования к разработке ядра.md">требования к разработке ядра</a>) с любым масштабом на исходном php-коде и js-скриптахс опорой на 4-е компонента: 1.Conditions, 2.Space, 3.Distribution и 4.Realization. Более подробно о CSDR <a target="_blank" href="https://github.com/veter-love/easy-oop.framework-life-balance">здесь</a>.
