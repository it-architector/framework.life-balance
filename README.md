...
Для минимизации ручного труда были утверждены облегчающие алгоритмы: фиксация сбоя, фоновый запуск, работа с базой данных массивами (в том числе авто-создание-изменение таблиц с полями), чпу по названиям категорий.
