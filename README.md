# Среда сопровождения разработки проекта
...
Среда состоит из 10-ти компонентов:
...
Среда сопровождает два направления разработки: ядра (back-end) и интерфейса (front-end). 
...
p.s.2. Как framework данная среда не подойдёт. Смотрите https://github.com/it-architector/release.framework-life-balance 
