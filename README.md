...
p.s.2. Данная платформа так же не сопровождает программирование, но дала шанс родиться <a target="_blank" href="https://github.com/it-architector/right.csdr">порядку csdr конструктивного кода</a>.
