...
class Resources implements Structure_Resources
{
    ...
    static function initiation()
    {
        ...
        $config_communications = Resources::include_information_from_file(DIR_RESOURCES,'настройка_коммуникаций','php');
        ...
        $schema_experiences = Resources::include_information_from_file(DIR_SCHEMES,'схема_наработок','php');
        ...
        $schema_data_base = Resources::include_information_from_file(DIR_SCHEMES,'схема_базы_данных','php');
    ...
    static function save_realized_schema_data_base($realized_schema){
        ...
        self::write_information_in_file(DIR_SCHEMES,'реализованная_схема_базы_данных','php', '<?php'."\n".' return '.var_export($realized_schema, true).'; ?>');
    ...
    static function get_information_realized_schema_data_base(){
        ...
        $realized_schema = self::include_information_from_file(DIR_SCHEMES,'реализованная_схема_базы_данных','php');
    ...
    static function create_communication_with_data_base(){
        ...
        try{
            ...
            if($config_protocols['queryes_data_base']){
                $file_log = DIR_PROTOCOLS . 'queryes_data_base.log';
            }
            else{
                $file_log = null;
            }
