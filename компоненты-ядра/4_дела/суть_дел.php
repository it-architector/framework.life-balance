...
class Business implements Structure_Business
{
    ...
    static function initiation(){
        ...
        $config_protocols = Resources::include_information_from_file(DIR_BUSINESS,'настройка_протоколов','php');
    ...
    static function fix_error($error_message, $file_name = null, $num_line_on_file_error = null, $stub = 'error'){
        ...
        if($config_protocols['errors_request_core'] == true){
            ...
            Resources::write_information_in_file(DIR_PROTOCOLS,'errors_request_core','log',
